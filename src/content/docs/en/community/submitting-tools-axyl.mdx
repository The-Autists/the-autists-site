...
2. Fill the variable inside PKGBUILD according to the tool information. If you are new on PKGBUILD, give a look to the [official Arch Linux documentation](https://wiki.archlinux.org/title/PKGBUILD). You can check several examples in [Axyl Projects repository](https://github.com/Axyl Projects-OS/Axyl Projects/tree/main/packages/pentesting)
